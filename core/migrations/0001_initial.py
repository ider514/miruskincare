# Generated by Django 2.2.14 on 2021-09-04 07:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('TS', 'Цэвэрлэгч'), ('TO', 'Тонер'), ('NT', 'Нарны тос'), ('HE', 'Хөгшрөлтийн эсрэг'), ('GU', 'Гуужуулагч'), ('ES', 'Эссэнц'), ('SE', 'Серум'), ('UA', 'Үс арчилгаа'), ('BA', 'Бие арчилгаа'), ('MA', 'Маск'), ('NB', 'Нүүрний будаг'), ('ZT', 'Зовхины тос')], max_length=2)),
